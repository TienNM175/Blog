...
import { Card, CardContent, Typography, Box, Button, Dialog } from '@mui/material';
...
export const PostDetails: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <Box sx={{ p: 3 }}>
          <Typography variant="h6" sx={{ mb: 2 }}>Edit Post</Typography>
          <PostForm
  initialData={post}
  onSubmit={(data) => {
    console.log("Submitting data:", data); // Log to ensure correct data
